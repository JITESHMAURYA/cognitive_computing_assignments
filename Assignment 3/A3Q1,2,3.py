import pandas as pd
#Q.1 Create the dataset as follow in the table
data = {
...
#2. Select rows from index 4 to 8 and columns 2 to 4
...
#3. Select all rows with column index 1 to 3 (include index 3)
